...
/>
      <div className="w-full flex flex-row items-center justify-between py-0 pr-20 pl-5 box-border gap-[2px] min-w-1/2">
        ...
        <div className="w-[132px] flex flex-row items-start justify-start py-6 pr-0 pl-0 box-border mq450:hidden">
          <div className="flex-1 flex flex-row items-center justify-start py-px pr-0 pl-0">
            <img
