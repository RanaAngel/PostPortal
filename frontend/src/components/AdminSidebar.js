      ...
      <div className="self-stretch flex flex-col items-end justify-start py-0 pr-0 pl-px gap-[43px]">
        ...
        <div className="self-stretch flex flex-row items-start justify-end py-0 pr-1 pl-[9px] mq450:items-start mq450:justify-start mq450:pl-px mq450:box-border">
          <div className="flex-1 flex flex-col items-start justify-start pt-0 px-2.5 pb-[23px] gap-[48px] mq450:w-20 mq450:items-start mq450:justify-start">
            <button
              className={`cursor-pointer [border:none] py-2.5 px-[39px] bg-[transparent] rounded-mid flex flex-col items-start justify-start ${isActive('/admindashboard') ? 'bg-mediumslateblue-300' : 'bg-gray-1300'} hover:bg-mediumslateblue-300 active:bg-button lg:hover:bg-mediumslateblue-300 mq450:self-stretch mq450:w-auto mq450:pl-7 mq450:box-border mq1050:hover:bg-mediumslateblue-300 mq1000:hover:bg-mediumslateblue-300`}
            ...
            <button
              className={`cursor-pointer [border:none] py-[11px] px-[37px] bg-[transparent] self-stretch rounded-mid flex flex-col items-start justify-start ${isActive('/users') ? 'bg-mediumslateblue-300' : 'bg-gray-1300'} hover:bg-mediumslateblue-300 lg:hover:bg-mediumslateblue-300 mq450:pl-7 mq450:box-border mq1050:hover:bg-mediumslateblue-300 mq1000:hover:bg-mediumslateblue-300`}
            ...
            <button
              className={`cursor-pointer [border:none] py-2.5 px-[39px] bg-[transparent] rounded-mid flex flex-col items-start justify-start ${isActive('/userpost') ? 'bg-mediumslateblue-300' : 'bg-gray-1300'} hover:bg-mediumslateblue-300 lg:hover:bg-mediumslateblue-300 mq450:self-stretch mq450:w-auto mq450:pl-7 mq450:box-border mq1050:hover:bg-mediumslateblue-300 mq1000:hover:bg-mediumslateblue-300`}
