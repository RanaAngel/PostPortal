...
const Library = () => {
 ...
 const [activeButton, setActiveButton] = useState('All');
  ...
  const handleClick = async (platform) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/facebook/filter', { platform });
  ...
  return (
    ...
    </nav>    <div className="w-full flex flex-row items-end justify-between gap-[7px] max-w-full mq450:flex-wrap">
                    <input
