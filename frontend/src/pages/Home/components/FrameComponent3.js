    ...
    >
      ...
      <div className="flex-1 flex flex-col items-end justify-start min-w-[645px] max-w-full mq900:min-w-full mq1300:items-center mq1300:justify-start">
        <div className="w-[886px] h-[787px] flex flex-col items-end justify-start pt-[141px] px-[57px] pb-[125px] box-border relative max-w-full mq450:pt-[60px] mq450:pb-[53px] mq450:box-border mq900:pt-[92px] mq900:px-7 mq900:pb-[81px] mq900:box-border">
          <div className="w-[513px] flex-1 flex flex-col items-start justify-start py-[77px] px-[73px] box-border gap-[10px] bg-[url('/public/laptop@2x.png')] bg-cover bg-no-repeat bg-[top] max-w-full z-[1] mq450:pt-[50px] mq450:pb-[50px] mq450:box-border mq900:w-[610px] mq900:pl-[90px] mq900:pt-[88px] mq900:pr-[90px] mq900:box-border">
            <img
              className="w-[513px] h-[521px] relative object-cover hidden max-w-full"
              alt=""
              src="/laptop@2x.png"
            />
            <div className="self-stretch h-[249px] flex flex-col items-center justify-center relative gap-[10px] bg-[url('/public/screenshot-20240602-221955-1@2x.png')] bg-cover bg-no-repeat bg-[top] z-[1] mq900:h-[300px]">
              <img
                className="self-stretch h-[249px] relative max-w-full overflow-hidden shrink-0 object-cover hidden z-[0]"
                alt=""
                src="/screenshot-20240602-221955-1@2x.png"
              />
              <img
