...
const LandingPage = () => {
  return (
    <div className="w-full relative bg-neutral-main-50 overflow-y-auto flex flex-col items-end justify-start pt-0 px-0 pb-[108.7px] box-border gap-[64px] tracking-[normal] leading-[normal] mq900:gap-[16px] mq1300:gap-[32px]">
      <NavTopBar />
